...
from tools.github import repos, issues
...
def invoke(
    ...
    session_id: Optional[str] = typer.Option(None, "--session-id", "-s", help="Session ID for conversation context"),
):
    """
...
def auth():
    ...
    if config.is_mock_mode():
        ...
        typer.echo("1. Create a GitHub OAuth App at: https://github.com/settings/developers")
...
def tools_command(
    ...
    tool_name: Optional[str] = typer.Option(None, "--name", "-n", help="Specific tool name"),
):
    """
